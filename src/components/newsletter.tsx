		...
		<section>
			<div className="max-w-6xl mx-auto px-4 sm:px-6">
				<div className="pb-12 md:pb-20 pt-16 md:pt-32">
					...
					{/* CTA box */}
					<div className="relative bg-darkgreen rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
						...
						<div className="relative flex flex-col lg:flex-row justify-between items-center">
							...
							<div className="text-center lg:text-left lg:max-w-xl">
								...
								<p className=" text-lightbrown text-lg mb-6"> Join our waiting list now to be among the first to experience BookLinkr.</p>
